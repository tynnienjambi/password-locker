...
class TestClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_user = User('Tinisha Kamau','XyZ3thf1')

    def test_init(self):
        """
        test case to chek if the object has been initialized correctly
        """
        self.assertEqual(self.new_user.username,'Tinisha Kamau')
...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credential = Credentials('Gmail','Tinisha Kamau','yx5Gij43')
    def test_init(self):
        """
    ...
    def test_save_many_accounts(self):
        ...
        '''
        self.new_credential.save_details()
        test_credential = Credentials("Twitter","Tinisha Kamau","Mfh45hfk") 
    ...
    def test_credential_exist(self):
        ...
        """
        self.new_credential.save_details()
        the_credential = Credentials("Twitter", "Tinisha Kamau", "Mfh45hfk")  
